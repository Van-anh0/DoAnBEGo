...
type ProductRankHandlers struct {
	service service.ProductRankInterface
}

func NewProductRankHandlers(service service.ProductRankInterface) *ProductRankHandlers {
	return &ProductRankHandlers{service: service}
}
...
// @Accept  json
// @Produce  json
// @Param data body model.ProductRankRequest true "body data"
// @Success 200 {object} interface{}
// @Router /api/v1/product-rank/create [post]
func (h *ProductRankHandlers) Create(r *ginext.Request) (*ginext.Response, error) {
	req := model.ProductRankRequest{}
	r.MustBind(&req)
...
func (h *ProductRankHandlers) Update(r *ginext.Request) (*ginext.Response, error) {
...
func (h *ProductRankHandlers) Delete(r *ginext.Request) (*ginext.Response, error) {
...
func (h *ProductRankHandlers) GetOne(r *ginext.Request) (*ginext.Response, error) {
...
func (h *ProductRankHandlers) GetList(r *ginext.Request) (*ginext.Response, error) {
	log := logger.WithCtx(r.GinCtx, utils.GetCurrentCaller(h, 0))

	req := model.ProductRankParams{}
