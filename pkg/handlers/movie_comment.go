...
type MovieCommentHandlers struct {
	service service.CommentInterface
}

func NewCommentHandlers(service service.CommentInterface) *MovieCommentHandlers {
	return &MovieCommentHandlers{service: service}
}
...
// @Accept  json
// @Produce  json
// @Param data body model.MovieCommentRequest true "body data"
// @Success 200 {object} interface{}
// @Router /api/v1/comment/create [post]
func (h *MovieCommentHandlers) Create(r *ginext.Request) (*ginext.Response, error) {
	req := model.MovieCommentRequest{}
	r.MustBind(&req)
...
func (h *MovieCommentHandlers) Update(r *ginext.Request) (*ginext.Response, error) {
...
func (h *MovieCommentHandlers) Delete(r *ginext.Request) (*ginext.Response, error) {
...
func (h *MovieCommentHandlers) GetOne(r *ginext.Request) (*ginext.Response, error) {
...
func (h *MovieCommentHandlers) GetList(r *ginext.Request) (*ginext.Response, error) {
	log := logger.WithCtx(r.GinCtx, utils.GetCurrentCaller(h, 0))

	req := model.MovieCommentParams{}
