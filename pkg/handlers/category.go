...
// @Accept  json
// @Produce  json
// @Param data body model.CategoryRequest true "body data"
// @Success 200 {object} interface{}
// @Router /api/v1/category/create [post]
func (h *CategoryHandlers) Create(r *ginext.Request) (*ginext.Response, error) {
...
func (h *CategoryHandlers) Update(r *ginext.Request) (*ginext.Response, error) {
...
func (h *CategoryHandlers) Delete(r *ginext.Request) (*ginext.Response, error) {
...
// @Param id path string true "id"
// @Success 200 {object} interface{}
// @Router /api/v1/category/get-one/:id [get]
func (h *CategoryHandlers) GetOne(r *ginext.Request) (*ginext.Response, error) {
...
// @Success 200 {object} interface{}
// @Router /api/v1/category/get-list [get]
func (h *CategoryHandlers) GetList(r *ginext.Request) (*ginext.Response, error) {
	log := logger.WithCtx(r.GinCtx, utils.GetCurrentCaller(h, 0))

	req := model.CategoryParams{}
